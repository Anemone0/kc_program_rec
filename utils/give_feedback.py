...
def give_feedback(train, test, rec):
...
def recover(train, test, rec):
    train_path, trainbk_path, test_path, testbk_path, rec_path, recbk_path = get_path(train, test, rec)
    shutil.copyfile(trainbk_path, train_path)
    shutil.copyfile(testbk_path, test_path)
    shutil.copyfile(recbk_path, rec_path)


if __name__ == '__main__':
    # give_feedback('train', 'test', 'result')
    recover('train', 'test', 'usercf_rec')
